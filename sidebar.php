...
<div class="row row-offcanvas row-offcanvas-right">
		<div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
		   ...
		   <div class="panel panel-inverse">
			 ...
			 <div class="panel-heading" style="background-color: #23395d;color: white;text-align: center;"><strong>Book a Room</div>
			  <div class="panel-body">	
						   <form  method="POST" action="#.php">
								<div class="col-xs-12 col-sm-12">
						            ...
						            <div class="form-group">
						            	<div class="row">
					            			<div class="col-xs-12 col-sm-12">
						           				 <button type="submit" class="btn btn-inverse" name="avail" style="background-color: #20456f;text-align: center;border:none;color:whitesmoke;position: relative;left:30px;">Check Availability</button>
						           			 </div>
						            	</div>
						            </div>
						        </div>
				...
				echo ' <div class="panel-heading" style="background-color: #23395d;color: white;text-align: center;">Customer Login </div>
					   <div class="panel-body">	
						   <form  method="POST" action="#.php">
								<div class="col-xs-12 col-sm-12">
						            ...
						            <div class="form-group">
						            	<div class="row">
					            			<div class="col-xs-12 col-sm-12">
						           				 <button type="submit" class="btn btn-inverse" align="right" name="login" style="background-color: #20456f;text-align: center;border:none;color:whitesmoke;position: relative;left:60px;">Log in</button>
						           			 </div>
						            	</div>
						            </div>
						        </div>
					...
					echo'<div class="panel-heading" style="color: white;text-align: center;background-color: #1C3D52;">Guest Information</div>
							   <div class="panel-body">	
									<div class="col-xs-12 col-sm-12">
									 ...
									 <span class="glyphicon glyphicon-cog"> </span> Email:<br/> <b>'. $_SESSION['email'].'</b><br/>
									  ...
									  <a style="text-align: center;background-color: #c4c4c4;" href="'.WEB_ROOT.'logout.php" class="btn btn-default" text-align="center">Logout <span class="glyphicon glyphicon-log-out"></span></a>
									</div>					            					            		
								</div>';
				 ...
				 <form name="clock">
					  ...
					  <input  style="text-align: center;padding:3px;" class="form-control" id="trans" type="label"  name="face" value="">
				</form>
